...
/**
 * Gestion d'un serveur : création d'une connexion de type serveur pour attendre
...
public class ServeurSocket extends Thread {
	...
	/**
	 * objet pour une connexion de type serveur (pour attendre des connexions de
	 * clients)
	 */
	...
	public ServeurSocket(AsyncResponse delegate, int port) {
		...
		try {
			...
			// le démarrage de l'écoute ne peut se faire que si un objet delegate existe
	...
	public void run() {
		...
		while (true) {
			try {
				...
				// création d'une connexion vers ce client, pour la communication (envoi et
